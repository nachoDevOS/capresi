...
@section('page_title', 'Reporte Registro de Inventario')
@if(auth()->user()->hasPermission('browse_printsales')  )
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body" style="padding: 0px">
                        <div class="col-md-8" style="padding: 0px">
                            <h1 class="page-title">
                                <i class="voyager-calendar"></i> Reporte de Ventas
                            </h1>
                        </div>
                        <div class="col-md-4" style="margin-top: 30px">
                            <form name="form_search" id="form-search" action="{{ route('print-sales.list') }}" method="post">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="date" name="finish" required class="form-control">
                                        <small>Fin</small>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                {{-- <div class="form-group">
                                    <div class="form-line">
                                        <select name="typePayment" id="typePayment" class="form-control select2" required>
                                            <option value="" disabled selected>--- Seleccione una opcion ---</option>                                      
