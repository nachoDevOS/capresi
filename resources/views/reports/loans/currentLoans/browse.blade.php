                ...
                <div class="panel panel-bordered">
                    <div class="panel-body" style="padding: 0px">
                        <div class="col-md-8" style="padding: 0px">
                            <h1 class="page-title">
                                <i class="voyager-calendar"></i> Reporte de Prestamios Vigentes
                            </h1>
                        </div>
                        <div class="col-md-4" style="margin-top: 30px">
                            <form name="form_search" id="form-search" action="{{ route('reports-loans.currentloans.list') }}" method="post">
                                ...
                                {{-- <div class="form-group">
                                    <div class="form-line">
                                        <input type="date"  class="form-control" required id="start" name="start">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="date"  class="form-control" required id="finish" name="finish">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" name="type" value="grouped" checked> Agrupado
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="type" value="todo"> Todo
                                    </label>
                                </div>
