...
@section('page_title', 'Viendo Planilla de Aguinaldo')
                    ...
                    <div class="panel-body" style="padding: 0px">
                        <div class="col-md-8" style="padding: 0px">
                            <h1 id="titleHead" class="page-title">
                                <i class="fa-solid fa-money-check-dollar"></i> Planillas de Aguinaldo
                            </h1>
                        </div>
                        <div class="col-md-4 text-right" style="margin-top: 30px">
                            @if (auth()->user()->hasPermission('add_bonus'))
                                <a href="{{ route('bonus.create') }}" class="btn btn-success">
...
@section('javascript')
    ...
    <script>
        ...
        function list(page = 1){
            ...
            let url = '{{ url("admin/bonus/ajax/list") }}';
