...
@if (auth()->user()->hasPermission('add_spreadsheets'))
    @section('page_header')
        <h1 id="titleHead" class="page-title">
            <i class="fa-solid fa-money-check-dollar"></i> Crear Planilla de Aguinaldo
        </h1>
        <a href="{{ route('bonus.index') }}" class="btn btn-warning">
    ...
    @section('content')
        <div class="page-content edit-add container-fluid">    
            <form id="agent" action="{{ route('bonus.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="panel-body">    
                                ...
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="number" class="form-control text" required name="year" min="2024" max="2100" step="1" value="2024" />
