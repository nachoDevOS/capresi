                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 text-right">
                                ...
                                <label class="radio-inline"><input type="radio" class="radio-type" name="optradio" value="vigente" checked>Vigentes</label>
                                <label class="radio-inline"><input type="radio" class="radio-type" name="optradio" value="pendiente">Pendientes</label>

                                <label class="radio-inline"><input type="radio" class="radio-type" name="optradio" value="finalizado">Finalizados</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa-solid fa-file-signature"></i> Aprobar</h4>
                </div>
                    ...
                    <form action="#" id="success_form" method="GET">
                        ...
                        <input type="hidden" name="id" id="id">
                            ...
                            <div class="text-center" style="text-transform:uppercase">
                                <i class="fa-solid fa-file-signature" style="color: rgb(68, 68, 68); font-size: 5em;"></i>
                                <br>
                                
                                <p><b>Desea aprobar el contrato?</b></p>
                            </div>
                        <input type="submit" class="btn btn-info pull-right delete-confirm" value="Sí, aprobar">
                    </form>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="#" id="rechazar_form" method="GET">
                        {{ csrf_field() }}
                            <div class="text-center" style="text-transform:uppercase">
                                <i class="fa-solid fa-file-signature" style="color: #353d47; font-size: 5em;"></i>
                                <br>
                                
                                <p><b>Desea rechazar el siguiente contrato?</b></p>
                            </div>
