...
<body>
    ...
    <div class="company-header">
        ...
        <div style="font-size: 10px;">N° {{ $pawn->code }}</div>
    </div>
    ...
    <table>        
        <tr>
            ...
            <td class="uppercase">{{ $pawn->person->last_name1 }} {{ $pawn->person->last_name2 }}, {{ $pawn->person->first_name }}</td>
        </tr>
        <tr>
            <td><span class="bold">CI/NIT:</span></td>
            <td>{{ $pawn->person->ci }}</td>
        </tr>
    </table>
    ...
    <table>
        ...
        <tbody>
            @php $total = 0; @endphp
            @foreach ($pawnMonthAgent as $item)
            <tr>
    ...
    <table>
        ...
        <tr>
            ...
            <td class="uppercase">{{ $pawnMonthAgent[0]->name }}</td>
        </tr>
